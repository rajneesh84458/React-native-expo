...
render(){
    ...
    return(
      ...
      <Text style={{textAlign:'center',fontSize:20,color:'white'}}>Bus details</Text>
       </View>
...
<TextInput name="address-book" style={styles.name}  placeholder="Bus No."/>
     ...
     <TextInput name="address-book" style={styles.class}  placeholder="Driver Name"/>

    </View>

 <View style={styles.third}>

 <TextInput name="address-book" style={styles.Bus}  placeholder="Contact No."/>
